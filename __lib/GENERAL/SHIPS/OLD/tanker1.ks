//ВЫВОД НА ОРБИТУ  около 80 км tanker1
...
function gettoorbit {
  ...
  print "We are in orbit: " + round(apoapsis,2) + "x" + round(periapsis,2) + " km. Deploying payload fairing. ".
  ...
  SetDishTarget("HighGainAntenna5",0,"Molniya-1").

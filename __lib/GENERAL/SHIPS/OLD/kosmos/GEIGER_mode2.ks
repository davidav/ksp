// GEIGER_mode2-  к спутнику связи на орбите муны 40 гр слева ()
//вывод на  опорную орбиту  80000 
//трансфер на орбиту муны 11 400 000
//включение антен
//отправляем на -29 (с поправкой 10 (35km))
...
set SatelliteAngle to -29.//положение спутника относительно Муны

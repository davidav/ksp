//вывод на  орбиту  Т=1час (448883 м) TEAM_service_module or TEAM_life_module
...
until cyclogram = 0 {
    if cyclogram = 1{
        ...
        print "CYCLOGRAM: "+cyclogram+" - "+namecyclogram at(5,2).
        set GTstart to 5500.// высота начала разворота
		...
		wait 3.
		set DayLen to SHIP:Body:ROTATIONPERIOD/6.//период обращения на требуемой орбите (1 час)
		...
		wait 1.		
		SetDishTarget("HighGainAntenna5",1,"Molniya103").

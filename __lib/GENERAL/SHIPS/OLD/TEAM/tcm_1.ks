//вывод на  орбиту  Т=1час (448883 м) TEAM_command_module

//CORE:PART:GETMODULE("kOSProcessor"):DOEVENT("Open Terminal").

clearscreen. 
set Horb to 448883.//высота орбиты
...
until cyclogram = 0 {
    ...
    if cyclogram = 1{
        ...
        print "CYCLOGRAM: "+cyclogram+" - "+namecyclogram at(5,2).
        set GTstart to 7000. // высота начала разворота        
        ...
        set GTendAP to 120000. // заканчиваем разворот, когда апоцентр на этой высоте
        set v45 to 900. // скорость, при которой угол тангажа должен быть 45 градусов
        set pitch to 0.        
        lock GTpitch to 90 - vang( up:vector, velocity:surface ).//угол от горизонтали до курса
        until altitude > 400000 {
            ...
            nextstage().
			CapTWR(maxTWR).
			if altitude>70000 LIGHTS ON.//сброс обтекателя  
        }
    }
    else if cyclogram = 4{
        clearscreen.

...
set Horbop to 100000.//высота орбиты
set GTstart to 3000.// высота начала разворота
set GTendAP to 74000. // заканчиваем разворот, когда апоцентр на этой высоте
set v45 to 650. // скорость, при которой угол тангажа должен быть 45 градусов

set targetPitch to 90.
set targetHead to 148.4.
set cyclogram to 1.
set maxTWR to 2.0.
...
until cyclogram = 0 {
    if cyclogram = 1{
        ...
        SetLinkTarget("HighGainAntenna5",0,"link_2").
		wait 1.
		print "ANTENNA #1 IS TUNED TO REPEATER link_2" at(5,5).
		wait 1.		
		SetLinkTarget("HighGainAntenna5",1,"link_3").
		print "ANTENNA #2 IS TUNED TO link_3" at(5,6).
        wait 3.      		
        set cyclogram to 0.
    }
}

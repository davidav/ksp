//универсал
//ожидание необходимого стартового окна (RequestDistance)
//вывод на  орбиту  80000 (Horbop)
// включение двух антенн (link_kso_1, link_kso_2)
...
until cyclogram = 0 {
    ...
    if cyclogram = 2{
        ...
        SetLinkTarget("HighGainAntenna5",0,"link_kso_2").
		wait 1.
		print "ANTENNA #1 IS TUNED TO REPEATER link_kso_2" at(5,5).
		wait 1.		
		SetLinkTarget("HighGainAntenna5",1,"link_kso_1").
		print "ANTENNA #2 IS TUNED TO link_kso_1" at(5,7).
        wait 1.      		
        set cyclogram to 0.
    }

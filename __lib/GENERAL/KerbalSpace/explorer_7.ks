//вывод на  орбиту  700000 300000  с наклонением 47.8 - 52.8     
//по факту   705239 x 300612  49.5
set nameProgramm to "explorer-7".
...
set targetHead to 38.
set cyclogram to 1.
set maxTWR to 1.8.
set Horbop to 703000.
set GTstart to 3000.

//вывод на  полярную орбиту (северное направление)  100000

set nameProgramm to "voshod_1".
...
set GTendAP to 65000. // заканчиваем разворот, когда апоцентр на этой высоте

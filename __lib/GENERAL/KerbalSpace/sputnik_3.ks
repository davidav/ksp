//вывод на  орбиту  130000 90000     с наклонением 63,5
//по факту  131172, 91436, 63,3
set nameProgramm to "sputnik_3".
...
set targetHead to 23.1.
set cyclogram to 1.
set maxTWR to 1.8.
set Horbop to 130000.
set GTstart to 3000.
...
until cyclogram = 0 {
    if cyclogram = 1{
        ...
        until ETA:Apoapsis<1 {
            ...
            if altitude > 71000 {
                if STAGE:NUMBER =4{
                print "separating fairing" at(5,6).
                wait 2.
                stage.
                print "separating first stage " at(5,7).
                wait 2.
                stage.
                }
            }

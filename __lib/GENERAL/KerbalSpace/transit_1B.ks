//вывод на  орбиту  350000 170000  с наклонением 48.5 - 53.5     
//по факту   
set nameProgramm to "transit_1B".
...
set targetHead to 39.
set cyclogram to 1.
set maxTWR to 1.8.
set Horbop to 355000.
set GTstart to 3000.
set GTendAP to 75000.
set v45 to 550.

//вывод на  орбиту  328200 100000  с наклонением 30,3 - 35,3
// по факту 

set nameProgramm to "vanguard-3".
...
set targetHead to 55.
set cyclogram to 1.
set maxTWR to 1.8.
set Horbop to 333000.
set GTstart to 3000.
set GTendAP to 70000.
set v45 to 550.
...
until cyclogram = 0 {
    if cyclogram = 1{
        ...
        wait 1.
        SetLinkTarget("longAntenna",2).
		wait 1.		
		SetLinkTarget("longAntenna",3).
        EnableDevice ("solarPanels3", 0, "ModuleDeployableSolarPanel", "Extend Solar Panel").
        EnableDevice ("solarPanels3", 1, "ModuleDeployableSolarPanel", "Extend Solar Panel").
        set cyclogram to 0.
    }
}

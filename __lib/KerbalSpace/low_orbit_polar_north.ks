...
set nameProgramm to "low_orbit_polar_north".
...
set cyclogram to 1.
set maxTWR to 1.8.
set Horbop to 450000.//высота опорной орбиты
...
function emptytank{
  parameter TankName.
  parameter StageTime_p.
  LIST ENGINES IN myEngines.
  FOR eng IN myEngines {
    if (eng:TAG = TankName and firstStage) {
        if eng:FLAMEOUT {
        WAIT StageTime_p. 
        STAGE.
        set  firstStage to 0.
...
until cyclogram = 0 {
    ...
    if cyclogram = 1{
        ...
        until altitude > Horbop {
            ...
            nextstage().
            //emptytank(firstStage, StageTimePause).
            //emptytank(seсondStage, StageTimePause).
			CapTWR(maxTWR). 
        }
    }
    else if cyclogram = 4{

//вывод на  орбиту  384000 125000  с наклонением 30,8 - 35,8
// по факту 386917   128373  33
set nameProgramm to "vanguard_1".
...
until cyclogram = 0 {
    if cyclogram = 1{
        ...
        wait 1.
        SetLinkTarget("longAntenna",4).
		wait 1.		
		SetLinkTarget("longAntenna",5).
        wait 1.

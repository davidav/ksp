// link_kso_5 - коммерческий спутник на геостационарной орбите 100 гр  ЦУП.
...
//в перспективе перевод на полярную орбиту в качестве спутника связи
...
set SatelliteAngle to 100.//положение спутника относительно ЦУП

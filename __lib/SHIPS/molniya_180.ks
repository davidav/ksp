// molniya_180 - спутник связи на геостационарной орбите 180 гр от ЦУП
//сброс  обткателя AG3, 
//первой ступени AG4 
//развертавание солнечных панелей AG5
//открытие отсека и включение всенаправленной антены AG7
...
set nameProgramm to "molniya_180".
set releaseObtekatel to 71000.
set keyReleaseObtekatel to 1.

set ship:control:pilotmainthrottle to 0.
SAS off.
RCS off.

set SatelliteAngle to 180.//положение спутника относительно ЦУП
...
until cyclogram = 0 {
    if cyclogram = 1{
        ...
        until altitude > Horbop {
            ...
            if (altitude > releaseObtekatel and keyReleaseObtekatel) {
                AG3 ON. // сброс обтекателя
                WAIT 5.
                set keyReleaseObtekatel to 0.                    
            }
            nextstage().
			CapTWR(maxTWR). 
        }
        ...
        until ETA:Apoapsis<1 {
            ...
            if (altitude > releaseObtekatel and keyReleaseObtekatel) {
                AG3 ON. // сброс обтекателя
                WAIT 5.
                AG7 ON. //развертавание всенаправленной антены               
                set keyReleaseObtekatel to 0.
                wait 5.
                AG4 ON. // отделение первой ступени
                WAIT 5.
                AG5 ON. //развертавание солнечных панелей 
                print "Equipment enable"  at(5,15).
            }
        }
        wait 0.5.
        set cyclogram to 5. 
        ...
        SetLinkTarget("HighGainAntenna5",0,"molniya_60").
		wait 1.
		print "ANTENNA #1 IS TUNED TO REPEATER Mission Control" at(5,5).
		wait 1.     
        set cyclogram to 7.
    }    
    else if cyclogram = 7{

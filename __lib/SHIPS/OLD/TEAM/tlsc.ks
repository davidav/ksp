//вывод на  орбиту  238600 TEAM_LIFE_SUPPORT_CARGO
CORE:PART:GETMODULE("kOSProcessor"):DOEVENT("Open Terminal").
clearscreen.

SET RequiredAngle TO 0.
...
//function emptytank{
//  parameter TankName.
//  set emptytank to ship:partsnamed(TankName).
//  set qttfuel to emptytank:AMOUNT.
//  print  qttfuel at(5,5).
//  if qttfuel<1 {
//    stage.
//    wait 0.1.
//    print "Отделение пустых баков" at(5,5).
//  }
//}
...
until cyclogram = 0 {
    if cyclogram = 1{
        set namecyclogram to "WAITING TIME START".
        print "CYCLOGRAM: "+cyclogram+" - "+namecyclogram at(5,2).        
//        LOCK ActualAngle TO Round(SHIP:GEOPOSITION:LAT,3)-Round(target:GEOPOSITION:LAT,3).
//        UNTIL RequiredAngle=ActualAngle{
//            print "RequiredAngle: "+RequiredAngle at(5,3).
//            print "ActualAngle: "+ActualAngle at(5,4).
//        } 
        clearscreen.
        set cyclogram to 2.
    }        
        ...
        print "CYCLOGRAM: "+cyclogram+" - "+namecyclogram at(5,2).
        set GTstart to 5000.// высота начала разворота
        ...
        set GTendAP to 80000. // заканчиваем разворот, когда апоцентр на этой высоте
		...
		set Horbop to 238000.//высота опорной орбиты

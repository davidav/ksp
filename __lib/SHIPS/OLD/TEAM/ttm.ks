//вывод на  орбиту  238600 TEAM_teplica_module
...
until cyclogram = 0 {
    if cyclogram = 1{
		...
		nextstage().
		CapTWR(maxTWR).
        if solidoff and STAGE:SOLIDFUEL<1 {
        stage.
        wait 1.
        set solidoff to false.
        print "Отделение пустых баков" at(5,5).
        }
        if altitude > GTstart {
            set cyclogram to 3.
        ...
        set v45 to 750. // скорость, при которой угол тангажа должен быть 45 градусов
        set pitch to 0.        

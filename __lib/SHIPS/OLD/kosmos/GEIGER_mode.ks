//GEIGER_mode -  к спутнику связи на геостационарной орбите 180 гр от ЦУП 
//одно место
//
//вывод на  опорную орбиту  80000 (Horbop)
//
//отправляем на 182 (с поправкой 2 ???)
//
...
set SatelliteAngle to 178.//положение спутника относительно ЦУП
...
until cyclogram = 0 {
    if cyclogram = 1{
		...
		until (ETA:Apoapsis<50){
			...
			If ETA:Apoapsis<10 set kuniverse:timewarp:warp to 0.
			wait 1.
		}
        set cyclogram to 11.
	}

//вывод на  орбиту  80000
// включение двух антенн
...
set RequestDistance to 300000.//Требуемая дальность
...
until cyclogram = 0 {
    ...
    if cyclogram = 0.1{
        ...
        until DistanceTarget < RequestDistance{
            If (DistanceTarget<(RequestDistance+10000)) set kuniverse:timewarp:warp to 0.

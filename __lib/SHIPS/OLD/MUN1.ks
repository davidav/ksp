...
//трансфер на орбиту муны 11 400 000 и 3гр справа
//включение антен
...
set SatelliteAngle to 3.
set Horbop to 100000.//высота опорной орбиты
set GTstart to 3000.// высота начала разворота
set GTendAP to 70000. // заканчиваем разворот, когда апоцентр на этой высоте
set v45 to 650. // скорость, при которой угол тангажа должен быть 45 градусов
...
until cyclogram = 0 {
    if cyclogram = 1{
        ...
        unlock throttle.        
		wait 1.
		print "TARGET ORBIT!" at(5,5).
		wait 5.
        set cyclogram to 10. 
    }
    else if cyclogram = 10{
 		DisplayCyclogram ("COMMUNICATION").           
        SetLinkTarget("HighGainAntenna5",0,"link_moon_1").
		wait 3.
		print "ANTENNA #1 IS TUNED TO REPEATER link_moon_1" at(5,5).
		wait 3.		
		SetLinkTarget("HighGainAntenna5",1,"link_moon_2").
		print "ANTENNA #2 IS TUNED TO link_moon_2" at(5,6).
        wait 3.      		
        set cyclogram to 0.
    }
}
    if cyclogram = 0 {
        ...
        unlock throttle.
        set ship:control:pilotmainthrottle to 0.
        print "PROGRAM FINISHED. NO ERROR." at(5,5).
        wait 5.
    }
// link_polar_7- коммерческий спутник (орбита 7 679 273, 6 774 066, 90)
//вывод на  полярную опорную орбиту  80000 
//включение антены на link_kso_1, link_kso_2
//расчет и занятие требуемого угла
//трансфер 
//в перспективе использование в качестве спутника связи на полярной орбите с 2х-синхронным периодом
...
set OrbitH to 7679273.// высота требуемой орбиты
